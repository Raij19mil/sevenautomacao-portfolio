  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,hsl(45_90%_50%/0.1),transparent_70%)]"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-[hsl(45_90%_50%)] rounded-2xl mb-6">
              <Globe className="w-10 h-10 text-[hsl(0_0%_10%)]" />
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6">
              Criação de <span className="bg-gradient-to-r from-[hsl(45_90%_50%)] to-[hsl(40_95%_60%)] bg-clip-text text-transparent">Sites</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-[hsl(45_90%_50%/0.2)] rounded-2xl p-8 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <h3 className="text-2xl font-bold text-foreground mb-6">Benefícios</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-[hsl(45_90%_50%)] flex-shrink-0 mt-1" />
          ...
          <div className="mb-20 animate-fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card/30 backdrop-blur-sm border border-[hsl(45_90%_50%/0.2)] rounded-2xl p-6 hover:scale-105 transition-all">
                <MessageCircle className="w-10 h-10 text-[hsl(45_90%_50%)] mb-4" />
          ...
          <div className="text-center bg-card/30 backdrop-blur-sm border border-[hsl(45_90%_50%/0.2)] rounded-3xl p-12 animate-fade-in" style={{ animationDelay: '0.8s' }}>
            ...
            <a 
              ...
              className="inline-flex items-center justify-center bg-[hsl(45_90%_50%)] hover:bg-[hsl(40_95%_60%)] text-[hsl(0_0%_10%)] font-bold py-5 px-10 rounded-xl text-lg transition-all transform hover:scale-105 hover:shadow-[0_0_40px_hsl(45_90%_50%/0.4)] border border-[hsl(45_90%_50%/0.2)]"
            >
              Solicitar Orçamento
            </a>
          </div>
